        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <div className="flex gap-3">
                {['تويتر', 'انستقرام', 'لينكدإن'].map((social, i) => (
                  <button key={i} className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 flex items-center justify-center text-white/60 hover:text-white/90 transition-all text-xs">
                    {social.charAt(0)}
                  </button>
                ))}
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {['إدارة المواعيد', 'ملفات المرضى', 'الفواتير', 'التقارير'].map((item, i) => (
                  <li key={i}><span className="text-white/60 hover:text-white/90 text-sm cursor-pointer transition-colors">{item}</span></li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2.5">
                {['من نحن', 'المدونة', 'الوظائف', 'تواصل معنا'].map((item, i) => (
                  <li key={i}><span className="text-white/60 hover:text-white/90 text-sm cursor-pointer transition-colors">{item}</span></li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2.5">
                {['مركز المساعدة', 'الأسئلة الشائعة', 'سياسة الخصوصية', 'الشروط والأحكام'].map((item, i) => (
                  <li key={i}><span className="text-white/60 hover:text-white/90 text-sm cursor-pointer transition-colors">{item}</span></li>
                ))}
              </ul>
            </div>
